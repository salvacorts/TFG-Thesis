...
\paragraph*{Evaluate handler.} Creates a new gRPC server that listens for requests from clients, asking for new individuals to evaluate or returning evaluated individuals. 
...
On the other hand, gRPC uses HTTP/2, an evolution of HTTP 1.0

%% Image of HTTP 1.0 vs HTTP/2

 

Explain gRPC vs REST from paper

show here code of the grpc service
	
\paragraph*{Evaluated handler.}
